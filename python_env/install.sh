...
export LDFLAGS="$LDFLAGS -L$OPENSSL_INSTALL_DIR/lib64 -L$OPENSSL_INSTALL_DIR/lib -Wl,-rpath=$OPENSSL_INSTALL_DIR/lib64 -Wl,-rpath=$OPENSSL_INSTALL_DIR/lib"
...
./configure --with-openssl=$OPENSSL_INSTALL_DIR --prefix=$PYTHON_INSTALL_DIR --with-lto --with-computed-gotos --with-ensurepip
if false; then
