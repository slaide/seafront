...
import {
    handleBusyIndicator,
    updateMicroscopeStatus,
    selectSitesByWellArea,
} from "./alpine-methods.js";
...
import { makeHistogram, histogramLayout, histogramConfig, updateHistogram } from "histogram";
...
const generate_alpine_object=() => ({
    ...
    /**
     * Load interface settings (theme, tooltip config, etc.) from browser localStorage for the current microscope.
    ...
    /**
     * Save interface settings (theme, tooltip config, etc.) to browser localStorage for the current microscope.
     */
...
/** @typedef {ReturnType<typeof generate_alpine_object>} AlpineMicroscopeState */

document.addEventListener("alpine:init", () => {
    Alpine.data("microscope_state", generate_alpine_object);
});
